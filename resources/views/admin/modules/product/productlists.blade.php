						...
						<tbody id="table-data">
							...
							<tr>
								...
								<td style="width:120px;" >
									...
									<p class="btn bg_secondary_grey mb-0 p-1 px-2 del-btn <?php echo 'btn'.$counter?>" data-store_id="{{$product->id}}" style="font-size: 13px;relative;cursor:pointer;" title="Delete product"> <i class="fa fa-trash"></i></p>
								</td>
