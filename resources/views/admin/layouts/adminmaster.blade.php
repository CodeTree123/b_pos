...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="{{ asset('public/frontEnd/images/brac_only_logo.png') }}">
	 <!--bootstrap-->
	...
	<link rel="stylesheet" type="text/css" href="{{asset('/')}}public/admin/asset/css/custom_style.css">
	...
	<style>
		...
		.del-modal{
			position: absolute;background-color:white;box-shadow: 0 0 6px 1px grey;z-index: 1;margin-top:-116px;display: none;padding: 20px;border-radius: 5px;
			right:55px;
		}
		.del-modal::after{
			content: ' ';
...
<body>
	...
	<nav class="navbar navbar-expand-lg shadow navbar-light bg-light " id="navbar" style="padding:1px; ">
		<a class="navbar-brand" style="padding:0px;" href="{{route('admin.dashboard')}}"> 
			<img  class=" ml-4" src="{{ asset('public/frontEnd/images/brac_full_logo.png') }}" style="width:100px ;">
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarcoll" style="padding-top:10px;">
			<ul class="navbar-nav mr-auto ">
				...
				<li class="nav-item dropdown p-1 ml-2"  >
					<a class="nav-link text_p_primary  " href="{{route('admin.stock.lowStockProduct')}}" title="{{$lowStock}} products are in low stock">
						<i class="fa fa-exclamation-triangle"   ></i><span class="warning-btn">{{$lowStock}}</span>
						
					</a>
				</li>
				<li class="nav-item dropdown p-1 ml-2"   title="Calculator" data-toggle="modal" data-target=".calculator_modal">
