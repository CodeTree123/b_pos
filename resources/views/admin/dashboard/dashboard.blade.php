...
<div class="container-fluid p-3">
  <div class="box">
    ...
    <div class="box-content">
     ...
     <div class="col-3 col-xs-12 p-2">
      <center>
       <a href="{{route('admin.supplierAdd')}}" class="btn bg_secondary_yellow quick-link">Add Supplier</a>
     </center>     
   </div>
   <div class="col-3 col-xs-12 p-2">
    <center>
     <a href="{{route('admin.productAdd')}}" class="btn  bg_secondary_violet quick-link" style="color:white">Add Product</a>
   </center>     
 </div>
 <div class="col-3 col-xs-12 p-2">
  <center>
   <a href="{{route('admin.purchaseAdd')}}" class="btn bg_secondary_orange quick-link">Add Purchase</a>
 </center>     
</div>
<div class="col-3 col-xs-12 p-2">
  <center>
...
<div class="col-3 col-xs-12 p-2">
  <center>
   <a href="{{route('admin.expenseAdd')}}" class="btn  bg_secondary_grey quick-link">Add Expense</a>
 </center>     
</div>
